...
Though actually, I feel like our code is incorrect here.  We are adding useragents to our unknown_urls...before we check to see if the url is actually unknown....is this just a quirk of our for loop or a mistake?  Like what happens when we try to append to a dict entry that doesn't exist?
