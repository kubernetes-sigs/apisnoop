...
* OpenAPI Over Views
  ...
  :ARCHIVE_TIME: 2019-10-06 Sun 21:27
  :ARCHIVE_FILE: ~/ii/apisnoop_v3/org/meta.org
  :ARCHIVE_CATEGORY: meta
  :END:
...
* 199: Populate Swaggers Up
  :PROPERTIES:
  :header-args:sql-mode+: :results silent
  :ARCHIVE_TIME: 2019-10-06 Sun 21:41
  :ARCHIVE_FILE: ~/ii/apisnoop_v3/org/meta.org
  :ARCHIVE_OLPATH: Loading Swagger Data
  :ARCHIVE_CATEGORY: meta
  :END:
...
* Older Views from Meta.org
  :PROPERTIES:
  :ARCHIVE_TIME: 2019-10-07 Mon 03:57
  :ARCHIVE_FILE: ~/ii/apisnoop/org/meta.org
  :ARCHIVE_CATEGORY: meta
  :END:
** Bucket Job Swagger Table, and Helper Functions
...
*** 110: api_operation_material view
    :PROPERTIES:
    :header-args:sql-mode+: :tangle ../apps/hasura/migrations/110_view_api_operation_material.up.sql
    :END:
...
**** Index
 ...
 #+END_SRC
*** 120: api_operation view of material
    :PROPERTIES:
...
*** 130: api_operation_parameter_material
    :PROPERTIES:
...
*** 140: api_operation_parameter view of material
    :PROPERTIES:
...
*** 160: api_operation_response view
    :PROPERTIES:
...
*** 170: api_schema view
    :PROPERTIES:
    :header-args:sql-mode+: :tangle ../apps/hasura/migrations/170_view_api_schema.up.sql
    :END:
**** Create
  ...
  #+END_SRC
*** 180: api_schema_field view
    :PROPERTIES:
    :header-args:sql-mode+: :tangle ../apps/hasura/migrations/180_view_api_schema_field.up.sql
    :END:
**** Create
...
** Loading Swagger Data
   ...
   :END:
*** 199: Populate bucket_job_swagger Up
    :PROPERTIES:
    :header-args:sql-mode+: :tangle ../apps/hasura/migrations/199_load_and_populate_swaggers.up.sql
    :header-args:sql-mode+: :results silent
    :END:
...
** Field Coverage
   ...
   :header-args:sql-mode+: :results silent
   :END:
*** 300: kind_field_path recursive view
    :PROPERTIES:
    :header-args:sql-mode+: :tangle ../apps/hasura/migrations/300_view_kind_field_path.up.sql
    :END:
