...
** raiinbow.yaml
       ...
       spec:
         ...
         template:
           ...
           spec:
             ...
             containers:
             - name: hasura
               image: "raiinbow/hasura:2019-10-31-17-12"
               ports:
               - containerPort: 8080
               env:
       ...
       spec:
         ...
         template:
           ...
           spec:
             ...
             containers:
             - name: postgres
               image: "raiinbow/postgres:2019-10-31-17-12"
               ports:
               - containerPort: 5432
               livenessProbe:
                 exec:
   ...
   #+begin_EXAMPLE
   [36mINFO[0m Pushing image 'raiinbow/hasura:2019-10-31-17-12' to registry 'docker.io' 
   [36mINFO[0m Pushing image 'raiinbow/postgres:2019-10-31-17-12' to registry 'docker.io' 
   #+end_EXAMPLE
