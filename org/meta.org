...
#+begin_src sql-mode
ERROR:  relation "raw_audit_events" already exists
#+end_src
...
#+BEGIN_SRC python :tangle load_audit_events.py
  ...
  def load_audit_events(bucket,job):
      ...
      # Ensure all of them are complete
      ...
      for logfile in sorted(glob.glob(download_path + '*kube-apiserver-audit*'), reverse=True):
...
#+BEGIN_SRC sql-mode :noweb yes :tangle ../apps/hasura/migrations/245_function_load_audit_events.up.sql
  set role dba;
...
#+begin_src sql-mode
SET
hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# hh$# CREATE FUNCTION
RESET
#+end_src
...
* Audit Events View
** Initial View
   #+BEGIN_SRC sql-mode :tangle ../apps/hasura/migrations/230_view_audit_events.up.sql
   ...
   #+BEGIN_SRC sql-mode
   SELECT audit_id, operation_id, event_verb, request_uri
   FROM audit_events
   LIMIT 3;
   #+END_SRC
   ...
   #+RESULTS:
   #+begin_src sql-mode
                  audit_id               |                operation_id                |    event_verb    |                    request_uri                     
   --------------------------------------+--------------------------------------------+------------------+----------------------------------------------------
    28a9b08e-8c39-4b2f-be08-5e4d12eb545b | deleteAppsV1CollectionNamespacedReplicaSet | deletecollection | /apis/apps/v1/namespaces/services-4757/replicasets
    28a9b08e-8c39-4b2f-be08-5e4d12eb545b | listAppsV1NamespacedReplicaSet             | deletecollection | /apis/apps/v1/namespaces/services-4757/replicasets
    28a9b08e-8c39-4b2f-be08-5e4d12eb545b | createAppsV1NamespacedReplicaSet           | deletecollection | /apis/apps/v1/namespaces/services-4757/replicasets
   (3 rows)
...
#+BEGIN_SRC sql-mode :eval never-export :tangle ../apps/hasura/migrations/150_view_api_operations.up.sql
  CREATE OR REPLACE VIEW "public"."api_operations" AS 
    SELECT raw_swaggers.id AS raw_swagger_id,
           ...
           regex_from_path(paths.key) as openapi_verb,
           d.key AS method,
...
#+BEGIN_SRC sql-mode
SELECT DISTINCT x_kubernetes_action, method
FROM api_operations
order by x_kubernetes_action;
#+END_SRC

#+RESULTS: Double check operation_id verbs
#+begin_src sql-mode
 x_kubernetes_action | method  
---------------------+---------
 connect             | delete
 connect             | get
 connect             | head
...
#+NAME: method = options
#+BEGIN_SRC sql-mode
SELECT operation_id, x_kubernetes_action, method
FROM api_operations
where method like 'options';
#+END_SRC

#+RESULTS:
#+begin_src sql-mode
                    operation_id                    | x_kubernetes_action | method  
----------------------------------------------------+---------------------+---------
 connectCoreV1OptionsNamespacedPodProxy             | connect             | options
 connectCoreV1OptionsNamespacedPodProxyWithPath     | connect             | options
 connectCoreV1OptionsNamespacedServiceProxy         | connect             | options
 connectCoreV1OptionsNamespacedServiceProxyWithPath | connect             | options
 connectCoreV1OptionsNodeProxy                      | connect             | options
 connectCoreV1OptionsNodeProxyWithPath              | connect             | options
(6 rows)
