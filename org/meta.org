...
#+begin_src sql-mode
ERROR:  database "hh" already exists
GRANT
ERROR:  role "dba" already exists
NOTICE:  role "hh" is already a member of role "dba"
GRANT ROLE
SSL connection (protocol: TLSv1.3, cipher: TLS_AES_256_GCM_SHA384, bits: 256, compression: off)
You are now connected to database "hh" as user "hh".
...
GRANT
GRANT
NOTICE:  role "hh" is already a member of role "pg_execute_server_program"
GRANT ROLE
#+end_src
...
#+BEGIN_SRC sql-mode :eval never-export :notangle ../hasura/migrations/200_view_api_resources_fields.up.sql
