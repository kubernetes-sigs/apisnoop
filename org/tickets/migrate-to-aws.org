...
** manifest
  ...
  #+begin_src shell
    export GHUSER=ii
    export GHNAME="Flux for APISnoop"
    ...
    fluxctl install \
            ...
            --git-label=flux \
            --git-path kustomize \
            --git-url=git@github.com:${GHUSER}/apisnoop \
            --git-user="${GHNAME}" > flux-manifest.yaml
  #+end_src

  #+RESULTS: generate k8s manifest for flux
  #+begin_example
  #+end_example
