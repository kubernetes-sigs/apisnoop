...
** workflows
  ...
  apisnoop:deployment/hasura    hasura              raiinbow/hasura:v2020.04.08-3    ready    locked
  ...
  apisnoop:deployment/postgres  postgres            raiinbow/postgres:v2020.04.08-3  ready    locked
  apisnoop:deployment/webapp    webapp              raiinbow/webapp:v2020.04.08-3    ready    locked
  #+end_example

** images
  #+begin_src shell
    fluxctl list-images -n apisnoop -l 2 2>/dev/null
  #+end_src
