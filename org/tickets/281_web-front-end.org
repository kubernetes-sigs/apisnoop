...
** TODO Derive proper object structure for sunburst
...
*** TODO reduce endpoints so it is array of objs, each key being operationID.
*** TODO Add size and color to endpoint object.
    Size is easy, color must be determined by our color object.

*** TODO reduce endpoints to be organized by level, category, then opID.
*** TODO build tree of root>children, level>children, category>children, endpoints.
** TODO get basic sunburst showing
...
*** Verify Pods Running
    ...
    apisnoop-auditlogger-5f6c4cb8c5-2w2bs   1/1     Running   4          5m1s
    hasura-5d447cc65d-ccwrg                 1/1     Running   3          5m1s
    postgres-b59f6c9c4-zm2xl                1/1     Running   0          3m47s
    #+end_src
