...
** TODO adjust endpoint coverage to include foreign key to api_operation
...
** TODO adjust our endpoint query to include details
** TODO Coverage stats show summary if on level and category, and detailed endoint coverage if on endpoint.
** TODO Show coverage info for current highlighted path to the right of sunburst.
...
*** Verify Pods Running
    ...
    apisnoop-auditlogger-5f6c4cb8c5-ljkss   1/1     Running   0          5d22h
    hasura-777765b7d4-spkrt                 1/1     Running   0          5d22h
    postgres-b59f6c9c4-mpdrv                1/1     Running   0          5d22h
    #+end_src
