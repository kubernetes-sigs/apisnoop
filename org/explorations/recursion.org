...
- OP.body.fieldB -> text
 ...
 | op_id | path                          | schema    | hit_per_audit_entry |
 |-------+-------------------------------+-----------+---------------------|
 | Foo   | {'spec'}                      | PodSpec   |                   1 |
 | Foo   | {'spec','container'}          | Container |                   1 |
 | Foo   | {'spec','container','ip'}     | text      |                   1 |
 | Foo   | {'spec','container','port'}   | int       |                   1 |
 | Foo   | {'spec','container','othera'} | PodOther  |                   1 |
 | Foo   | {'spec','container','otherb'} | PodOther  |                   1 |
 | Foo   | {'a','b','d'}                 | int       |                     |
 | Foo   |                               |           |                     |
 | Foo   |                               |           |                     |
 | Foo   |                               |           |                     |
