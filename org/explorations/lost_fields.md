- [PodSpec Field Count Verification](#sec-1)
  - [from api schema](#sec-1-1)
  - [from podspec<sub>field</sub><sub>summary</sub>](#sec-1-2)
  - [from podspec<sub>field</sub><sub>report</sub>](#sec-1-3)
- [Arrays and subtypes are currently uncounted](#sec-2)
  - [subtypes and arrays](#sec-2-1)
  - [everything else](#sec-2-2)
- [Tests Hitting unconformant endpoints](#sec-3)
  - [hostIPC](#sec-3-1)
  - [hostPID](#sec-3-2)
  - [priorityClassName](#sec-3-3)


# PodSpec Field Count Verification<a id="sec-1"></a>

## from api schema<a id="sec-1-1"></a>
...
## from podspec<sub>field</sub><sub>summary</sub><a id="sec-1-2"></a>
...
## from podspec<sub>field</sub><sub>report</sub><a id="sec-1-3"></a>
...
# Arrays and subtypes are currently uncounted<a id="sec-2"></a>

## subtypes and arrays<a id="sec-2-1"></a>
...
## everything else<a id="sec-2-2"></a>
...
# Tests Hitting unconformant endpoints<a id="sec-3"></a>

## hostIPC<a id="sec-3-1"></a>
...
## priorityClassName<a id="sec-3-3"></a>
