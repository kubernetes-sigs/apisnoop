...
* Creating a function
  This is based m ostly on lessons gleaned from [[https://www.gnu.org/software/emacs/manual/html_node/eintr/index.html][An Intro to Programming in Elisp]], and their walkthroughs on buffer functions.
