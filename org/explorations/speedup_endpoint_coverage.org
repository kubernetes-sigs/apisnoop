...
*** Verify Pods Running
    ...
    apisnoop-auditlogger-5f6c4cb8c5-2s4xj   1/1     Running   3          71m
    hasura-5d447cc65d-8k5g9                 1/1     Running   2          71m
    postgres-b59f6c9c4-nqv7t                1/1     Running   0          71m
    #+end_src
...
** Manually load swagger or audit events
   ...
   #+begin_src sql-mode
     select * from load_swagger(null, '1181711701108592640');
   #+end_src
   ...
   #+begin_SRC example
                                            load_swagger                                          
   -----------------------------------------------------------------------------------------------
    Success!  Added the swagger for job 1181711701108592640 from bucket ci-kubernetes-e2e-gci-gce
   (1 row)
