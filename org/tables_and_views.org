...
* snoopUtils: Our Python Functions
  :PROPERTIES:
  :header-args:python: :tangle "../apps/postgres/snoopUtils.py" :noweb yes
  :END:
** Our Imports
...
** Define fetch_swagger
   ...
   #+begin_src python :tangle "../apps/postgres/snoopUtils.py"
   ...
   Our bucket_job_swagger table will want to know the bucket, job, metadata, and swagger so we put them all into a dict
   
   #+NAME: return db-ready dict
   #+begin_src python
     return {
         bucket: bucket,
         job: job,
...
*** The Python function
    ...
    #+BEGIN_SRC python :eval never :exports code
      ...
      swagger = fetch_swagger(bucket, job)
      sql = """
      ...
      rv = plpy.execute(plan, [
          ...
          swagger['commit_hash'],
          swagger['metadata']['passed'],
          swagger['metadata']['result'],
          swagger['metadata']['metadata']['infra-commit'],
          swagger['metadata']['version'],
          int(swagger['metadata']['timestamp']),
          swagger['metadata']['metadata']['node_os_image'],
          swagger['metadata']['metadata']['master_os_image'],
          json.dumps(swagger)
      ])
