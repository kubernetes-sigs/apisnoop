...
#+BEGIN_SRC python
  def find_operation_id(openapi_spec, event):
    ...
    return op_id
#+END_SRC
** load_audit_events definitions
   #+NAME: load_audit_events
   #+begin_src  python
     def load_audit_events(bucket,job):
         ...
         downloads = {}
         bucket_url = GCS_LOGS + bucket + '/' + job + '/'
         ...
         swagger_url = K8S_GITHUB_RAW + commit_hash + '/api/openapi-spec/swagger.json'
...
#+BEGIN_SRC python :noweb yes :exports none
  ...
  import time
  import glob
  from snoopUtils import determine_bucket_job, load_audit_events
