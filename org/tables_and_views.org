...
** 110: audit_event Table
  :PROPERTIES:
  :header-args:sql-mode+: :tangle ../apps/hasura/migrations/110_table_audit_event.up.sql
  :END:
*** Create
...
** 300: Audit Event
  :PROPERTIES:
  :header-args:sql-mode+: :notangle ../apps/hasura/migrations/310_view_audit_event.up.sql
  :END:
...
#+begin_src sql-mode :results replace code
  select operation_id, tested from zendpoint_coverage limit 100;
#+end_src
...
#+begin_src sql-mode
                           operation_id                           | tested 
------------------------------------------------------------------+--------
 connectCoreV1DeleteNamespacedPodProxy                            | f
 connectCoreV1DeleteNamespacedPodProxyWithPath                    | f
 connectCoreV1DeleteNamespacedServiceProxy                        | f
 connectCoreV1DeleteNamespacedServiceProxyWithPath                | f
 connectCoreV1DeleteNodeProxy                                     | f
 connectCoreV1DeleteNodeProxyWithPath                             | f
 connectCoreV1GetNamespacedPodAttach                              | f
 connectCoreV1GetNamespacedPodExec                                | t
 connectCoreV1GetNamespacedPodPortforward                         | t
 connectCoreV1GetNamespacedPodProxy                               | f
 connectCoreV1GetNamespacedPodProxyWithPath                       | t
 connectCoreV1GetNamespacedServiceProxy                           | f
 connectCoreV1GetNamespacedServiceProxyWithPath                   | t
 connectCoreV1GetNodeProxy                                        | f
 connectCoreV1GetNodeProxyWithPath                                | t
 connectCoreV1HeadNamespacedPodProxy                              | f
 connectCoreV1HeadNamespacedPodProxyWithPath                      | f
 connectCoreV1HeadNamespacedServiceProxy                          | f
 connectCoreV1HeadNamespacedServiceProxyWithPath                  | f
 connectCoreV1HeadNodeProxy                                       | f
 connectCoreV1HeadNodeProxyWithPath                               | f
 connectCoreV1OptionsNamespacedPodProxy                           | f
 connectCoreV1OptionsNamespacedPodProxyWithPath                   | f
 connectCoreV1OptionsNamespacedServiceProxy                       | f
 connectCoreV1OptionsNamespacedServiceProxyWithPath               | f
 connectCoreV1OptionsNodeProxy                                    | f
 connectCoreV1OptionsNodeProxyWithPath                            | f
 connectCoreV1PatchNamespacedPodProxy                             | f
 connectCoreV1PatchNamespacedPodProxyWithPath                     | f
 connectCoreV1PatchNamespacedServiceProxy                         | f
 connectCoreV1PatchNamespacedServiceProxyWithPath                 | f
 connectCoreV1PatchNodeProxy                                      | f
 connectCoreV1PatchNodeProxyWithPath                              | f
 connectCoreV1PostNamespacedPodAttach                             | f
 connectCoreV1PostNamespacedPodExec                               | t
 connectCoreV1PostNamespacedPodPortforward                        | f
 connectCoreV1PostNamespacedPodProxy                              | f
 connectCoreV1PostNamespacedPodProxyWithPath                      | f
 connectCoreV1PostNamespacedServiceProxy                          | f
 connectCoreV1PostNamespacedServiceProxyWithPath                  | f
 connectCoreV1PostNodeProxy                                       | f
 connectCoreV1PostNodeProxyWithPath                               | f
 connectCoreV1PutNamespacedPodProxy                               | f
 connectCoreV1PutNamespacedPodProxyWithPath                       | f
 connectCoreV1PutNamespacedServiceProxy                           | f
 connectCoreV1PutNamespacedServiceProxyWithPath                   | f
 connectCoreV1PutNodeProxy                                        | f
 connectCoreV1PutNodeProxyWithPath                                | f
 createAdmissionregistrationV1beta1MutatingWebhookConfiguration   | f
 createAdmissionregistrationV1beta1ValidatingWebhookConfiguration | f
 createAdmissionregistrationV1MutatingWebhookConfiguration        | t
 createAdmissionregistrationV1ValidatingWebhookConfiguration      | t
 createApiextensionsV1beta1CustomResourceDefinition               | f
 createApiextensionsV1CustomResourceDefinition                    | t
 createApiregistrationV1APIService                                | t
 createApiregistrationV1beta1APIService                           | f
 createAppsV1NamespacedControllerRevision                         | f
 createAppsV1NamespacedDaemonSet                                  | f
 createAppsV1NamespacedDeployment                                 | t
 createAppsV1NamespacedReplicaSet                                 | t
 createAppsV1NamespacedStatefulSet                                | t
 createAuditregistrationV1alpha1AuditSink                         | f
 createAuthenticationV1beta1TokenReview                           | f
 createAuthenticationV1TokenReview                                | t
 createAuthorizationV1beta1NamespacedLocalSubjectAccessReview     | f
 createAuthorizationV1beta1SelfSubjectAccessReview                | f
 createAuthorizationV1beta1SelfSubjectRulesReview                 | f
 createAuthorizationV1beta1SubjectAccessReview                    | f
 createAuthorizationV1NamespacedLocalSubjectAccessReview          | f
 createAuthorizationV1SelfSubjectAccessReview                     | t
 createAuthorizationV1SelfSubjectRulesReview                      | f
 createAuthorizationV1SubjectAccessReview                         | t
 createAutoscalingV1NamespacedHorizontalPodAutoscaler             | f
 createAutoscalingV2beta1NamespacedHorizontalPodAutoscaler        | f
 createAutoscalingV2beta2NamespacedHorizontalPodAutoscaler        | f
 createBatchV1beta1NamespacedCronJob                              | t
 createBatchV1NamespacedJob                                       | t
 createBatchV2alpha1NamespacedCronJob                             | f
 createCertificatesV1beta1CertificateSigningRequest               | t
 createCoordinationV1beta1NamespacedLease                         | f
 createCoordinationV1NamespacedLease                              | t
 createCoreV1Namespace                                            | t
 createCoreV1NamespacedBinding                                    | f
 createCoreV1NamespacedConfigMap                                  | t
 createCoreV1NamespacedEndpoints                                  | t
 createCoreV1NamespacedEvent                                      | f
 createCoreV1NamespacedLimitRange                                 | t
 createCoreV1NamespacedPersistentVolumeClaim                      | t
 createCoreV1NamespacedPod                                        | t
 createCoreV1NamespacedPodBinding                                 | f
 createCoreV1NamespacedPodEviction                                | t
 createCoreV1NamespacedPodTemplate                                | t
 createCoreV1NamespacedReplicationController                      | t
 createCoreV1NamespacedResourceQuota                              | t
 createCoreV1NamespacedSecret                                     | t
 createCoreV1NamespacedService                                    | t
 createCoreV1NamespacedServiceAccount                             | t
 createCoreV1NamespacedServiceAccountToken                        | f
 createCoreV1Node                                                 | f
 createCoreV1PersistentVolume                                     | t
(100 rows)
...
#+begin_src sql-mode
select * from load_audit_events('ci-kubernetes-e2e-gci-gce', '1219613215860723712');
#+end_src
