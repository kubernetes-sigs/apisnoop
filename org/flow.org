...
**** TODO Issue 12: Write a query for endpoint, to see its info including the audit log its connected to
     :LOGBOOK:
     CLOCK: [2019-07-01 Mon 19:27]
     :END:
...
**** TODO Update README with dev setup and use.
