...
*** Define its loading function
   ...
   In the meantime, I can assign all of them the release value of "1.8".  There aren't any others that appear with 1.8 and so they'll be easy to isolate later...but it potentially throws the numbers off.

   First, let's describe our function and insert them without change.
    #+NAME: load_tests
    #+BEGIN_SRC sql-mode :results silent
      set role dba;
...
* Create stable_endpoint_first materialized view
  ...
  #+begin_src sql-mode
  drop materialized view stable_endpoint_first;
  #+end_src
...
* Track conformance progress
  ...
  #+begin_src sql-mode
    ...
    ---------+---------------+-----------+-----------------------------------+------------------------------------+------------------------------------+------------------------------------+-----------------+------------------------+--------------------------------
     1.8.0   |           273 |        17 |                                36 |                                 36 |                                  0 |                                  0 |             273 |                     36 |                            183
     1.9.0   |            63 |       149 |                                10 |                                  5 |                                  9 |                                 18 |             336 |                     68 |                             46
     1.10.0  |             9 |         0 |                                 0 |                                  0 |                                  4 |                                  0 |             345 |                     72 |                              5
     1.11.0  |             2 |         0 |                                 0 |                                  0 |                                  0 |                                  0 |             347 |                     72 |                              2
     1.12.0  |             1 |        11 |                                 0 |                                  0 |                                  0 |                                  0 |             348 |                     72 |                              1
     1.13.0  |             0 |        13 |                                 0 |                                  0 |                                  0 |                                  1 |             348 |                     73 |                              0
     1.14.0  |            18 |         2 |                                 0 |                                  0 |                                  2 |                                  0 |             366 |                     75 |                              9
     1.15.0  |             0 |        16 |                                 0 |                                  0 |                                  0 |                                  7 |             366 |                     82 |                              0
     1.16.0  |            28 |        55 |                                26 |                                 22 |                                  4 |                                 13 |             394 |                    121 |                              2
     1.17.0  |             8 |         4 |                                 0 |                                  0 |                                  0 |                                  7 |             402 |                    128 |                              8
     1.18.0  |             7 |         7 |                                 0 |                                  0 |                                  0 |                                  9 |             409 |                    137 |                              7
     1.19.0  |            14 |        21 |                                14 |                                 13 |                                  1 |                                  9 |             423 |                    160 |                              0
    (12 rows)
 ...
 I then save this view as "stable_conformance_progress" so that it will be easier to output as json
  ...
  #+NAME: conformance progress
  #+begin_src sql-mode
  create or replace view stable_conformance_progress as
    with current_stable_endpoints as (
      select endpoint
        from open_api
       where release = '1.19.0'
...
#+begin_src sql-mode :tangle p2g.sql
  begin;
  \t
  \a
  \o progress2.json
...
[
  {
    ...
    "new_endpoints": 273,
    "new_tests": 17,
    "new_endpoints_promoted_with_tests": 36,
    "new_endpoints_covered_by_new_tests": 36,
    "new_endpoints_covered_by_old_tests": 0,
    "old_endpoints_covered_by_new_tests": 0,
    "total_endpoints": 273,
    "total_tested_endpoints": 36,
    "endpoints_still_untested_today": 183
  },
  {
    "release": "1.9.0",
    "new_endpoints": 63,
    "new_tests": 149,
    "new_endpoints_promoted_with_tests": 10,
    "new_endpoints_covered_by_new_tests": 5,
    "new_endpoints_covered_by_old_tests": 9,
    "old_endpoints_covered_by_new_tests": 18,
    "total_endpoints": 336,
    "total_tested_endpoints": 68,
    "endpoints_still_untested_today": 46
  },
  {
    "release": "1.10.0",
    "new_endpoints": 9,
    "new_tests": 0,
    "new_endpoints_promoted_with_tests": 0,
    "new_endpoints_covered_by_new_tests": 0,
    "new_endpoints_covered_by_old_tests": 4,
    "old_endpoints_covered_by_new_tests": 0,
    "total_endpoints": 345,
    "total_tested_endpoints": 72,
    "endpoints_still_untested_today": 5
  },
  {
    "release": "1.11.0",
    "new_endpoints": 2,
    ...
    "total_endpoints": 347,
    "total_tested_endpoints": 72,
    "endpoints_still_untested_today": 2
  },
  {
    "release": "1.12.0",
    "new_endpoints": 1,
    ...
    "total_endpoints": 348,
    "total_tested_endpoints": 72,
    "endpoints_still_untested_today": 1
  },
  {
    "release": "1.13.0",
    "new_endpoints": 0,
    ...
    "new_endpoints_covered_by_new_tests": 0,
    "new_endpoints_covered_by_old_tests": 0,
    "old_endpoints_covered_by_new_tests": 1,
    "total_endpoints": 348,
    "total_tested_endpoints": 73,
    "endpoints_still_untested_today": 0
  },
  {
    "release": "1.14.0",
    "new_endpoints": 18,
    ...
    "new_endpoints_promoted_with_tests": 0,
    "new_endpoints_covered_by_new_tests": 0,
    "new_endpoints_covered_by_old_tests": 2,
    "old_endpoints_covered_by_new_tests": 0,
    "total_endpoints": 366,
    "total_tested_endpoints": 75,
    "endpoints_still_untested_today": 9
  },
  {
    "release": "1.15.0",
    "new_endpoints": 0,
    ...
    "new_endpoints_covered_by_new_tests": 0,
    "new_endpoints_covered_by_old_tests": 0,
    "old_endpoints_covered_by_new_tests": 7,
    "total_endpoints": 366,
    "total_tested_endpoints": 82,
    "endpoints_still_untested_today": 0
  },
  {
    "release": "1.16.0",
    "new_endpoints": 28,
    "new_tests": 55,
    "new_endpoints_promoted_with_tests": 26,
    "new_endpoints_covered_by_new_tests": 22,
    "new_endpoints_covered_by_old_tests": 4,
    "old_endpoints_covered_by_new_tests": 13,
    "total_endpoints": 394,
    "total_tested_endpoints": 121,
    "endpoints_still_untested_today": 2
  },
  {
    "release": "1.17.0",
    ...
    "old_endpoints_covered_by_new_tests": 7,
    "total_endpoints": 402,
    "total_tested_endpoints": 128,
    "endpoints_still_untested_today": 8
  },
  {
    "release": "1.18.0",
    "new_endpoints": 7,
    ...
    "new_endpoints_covered_by_new_tests": 0,
    "new_endpoints_covered_by_old_tests": 0,
    "old_endpoints_covered_by_new_tests": 9,
    "total_endpoints": 409,
    "total_tested_endpoints": 137,
    "endpoints_still_untested_today": 7
  },
  {
    "release": "1.19.0",
    "new_endpoints": 14,
    "new_tests": 21,
    "new_endpoints_promoted_with_tests": 14,
    "new_endpoints_covered_by_new_tests": 13,
    "new_endpoints_covered_by_old_tests": 1,
    "old_endpoints_covered_by_new_tests": 9,
    "total_endpoints": 423,
    "total_tested_endpoints": 160,
    "endpoints_still_untested_today": 0
  }
]
#+end_example
