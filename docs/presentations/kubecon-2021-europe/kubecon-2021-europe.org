...
* Conformance as Code
- conformance defined through the API and a conformance test suite
- this allows for tools to be built that fit within k8s workflows
...
** Get Results
    ...
    #+end_example
** Submit PR
- fork [[https://github.com/cncf/k8s_conformance][k8s conformance]] repo and open PR from your fork
...
* Conclusion
- Conformance is a great initiative with benefits for vendors and consumers
- We can use awesome tools like Sonobuoy and APISnoop to validate clusters and strengthen conformance
* Q&A
* Footnotes
** original
*** About ii
