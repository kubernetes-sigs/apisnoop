...
- +9 in 1.18
- +40 in 1.19
*** 14 Endpoints release to Stableub.com/kubernetes/kubernetes/pull/91685][#91685]]
...
- 13 Endpoints where promoted to Stable with conformance tests **DID **DID AN ENDPOIT SNEAK IN WITHOUT A TEST? Asked zz on friday, follow-up. AN ENDPOIT SNEAK IN WITHOUT A TEST? Asked zz on friday, follow-up.
...
*** +32 Endpoints Backlogged by Tooling Requests
