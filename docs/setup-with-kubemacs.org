...
* Next Steps
  The default file you are dropped into is the README for apisnoop.  From this point forward you can interact with this repo through org files.  This'll let you do cool stuff like execute the code blocks listed in the documentation and write your own code blocks to run ad-hoc sql queries and what not.  Check out the [[file:/blob/master/README.org][README]], then move to [[file:test-writing.org][docs/test-writing.org]] to understand the context and motivation for apisnoop's test-writing flow.
