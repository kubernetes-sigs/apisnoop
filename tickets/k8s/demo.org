...
** Test the functionality in Go
   ...
   #+begin_src go
     ...
     func main() {
       ...
       if coolCount >= 55 {
           fmt.Println("there are too much coolness found")
           return
       }
       // TEST ENDS HERE
...
#+begin_src go
       ...
       podCount := len(pods.Items)
       framework.Expect(podCount == 0, "there are no Pods found")

       fmt.Println(podCount, "Pods found, checking their numbers")
	
       framework.Expect(coolCount >= 55, "there are too much coolness found")
#+end_src
* Final notes                                                        :export:
