...
import csv
import sys
from snoopUtils import deep_merge, get_html, download_url_to_path, load_openapi_spec, determine_bucket_job, fetch_swagger, get_all_auditlog_links, find_operation_id, load_audit_events
...
#     #####
#     # Load the resultin g updated audit.log directly into raw_audit_event
...
insert_audits_into_db(download_path, auditlog_path)
$$ LANGUAGE plpython3u ;
reset role;
