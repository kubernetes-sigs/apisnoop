...
def cluster_swagger():
    """Gets the swagger generated by a k8s api server.
       assumes a token is available at token.txt"""
    url = 'https://kubernetes/openapi/v2'
    token = Path('/run/secrets/kubernetes.io/serviceaccount/token').read_text()
