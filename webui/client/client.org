...
* Tasks                                                            :apisnoop:
** NEXT Remove 'E2E Only' from releases list
...
** TODO Drop Conformance Section from Releases List
  [[https://github.com/cncf/apisnoop/issues/79][github 79]]
** TODO Remove Name Sig from Release Index Title
  [[https://github.com/cncf/apisnoop/issues/78][github issue 78]]
** TODO Releases Should Always be sorted Numerically
  [[https://github.com/cncf/apisnoop/issues/76][github issue 76]]
** TODO
** TODO Be Able to filter all endpoints by some regular expression
...
*** TODO The filter should work on level category, endpouint
