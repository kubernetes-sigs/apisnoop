...
- [2/5] Method To Explore and Build This:
  ...
  - [ ] Add that reducer value to our url.
  - [ ] Show that url value no matter what release they are on.
  - [ ] filter the endpoints by this filter.
