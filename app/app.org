...
** Tests Search Container
   :PROPERTIES:
   :header-args: :tangle no
   :END:

   I don't wanna have a name clash with filtering a single test (to see its sequence) so we are calling this one "tests"

   #+NAME: Tests Search Container
   #+BEGIN_SRC js
     import React from 'react'
     import { connect } from 'redux-bundler-react'
     import SearchBar from './search-bar'
...
** Tests Filter Container
   :PROPERTIES:
   :header-args: :tangle ./src/components/tests-filter-container.js
   :END:
   #+NAME: TestsFilterContainer
   #+BEGIN_SRC js
     import React from 'react'
     import { connect } from 'redux-bundler-react'
...
** Tests Search Container
   :PROPERTIES:
   :header-args: :tangle ./src/components/tests-search-container.js
   :END:
