...
* Understanding our Client
  This is a web interface to the data curation we are doing as the APISnoop project.  The purpose is to display previously unseen connections between the testing coverage of kubernetes, and the people and communities for which this testing coverage matters.
* Architecture
